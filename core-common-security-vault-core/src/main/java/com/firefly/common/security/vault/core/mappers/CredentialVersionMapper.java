...
/**
 * Mapper for CredentialVersion entity and DTO
 */
@Mapper(componentModel = "spring")
public interface CredentialVersionMapper {

    CredentialVersionDTO toDTO(CredentialVersion entity);

    @Mapping(target = "createdAt", ignore = true)
    CredentialVersion toEntity(CredentialVersionDTO dto);
}
